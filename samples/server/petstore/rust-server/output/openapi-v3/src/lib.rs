...
pub trait Api<C> {
    ...
    async fn xml_other_put(&mut self, string: Option<crate::models::AnotherXmlArray>, context: &C) -> Result<XmlOtherPutResponse, ApiError>;

    /// Post an array
    async fn xml_post(&mut self, string: Option<crate::models::XmlArray>, context: &C) -> Result<XmlPostResponse, ApiError>;
...
pub trait ApiNoContext {
    ...
    async fn xml_other_put(&mut self, string: Option<crate::models::AnotherXmlArray>) -> Result<XmlOtherPutResponse, ApiError>;

    /// Post an array
    async fn xml_post(&mut self, string: Option<crate::models::XmlArray>) -> Result<XmlPostResponse, ApiError>;
